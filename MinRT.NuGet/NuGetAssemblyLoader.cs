...
public sealed class NuGetAssemblyLoader
{
    ...
    {
        // Use the full RID graph generated from Microsoft.NETCore.Platforms runtime.json.
        // This handles complex fallbacks like "alpine-x64" -> "alpine" -> "linux-musl-x64" -> "linux-musl" -> "linux-x64" -> "linux" -> "unix" -> "any".
        // The graph is auto-generated by tools/generate-rid-graph.cs and updated via GitHub Actions.
        return RidGraph.GetFallbackChain(rid).ToList();
    }
